...
export default function HallOfHeroesPortal() {
  ...
  return (
    <HeroesLayout titleKey="hero.hallOfHeroes" subtitleKey="hero.tagline">
      ...
      {/* Footer corregido: Se eliminó bg-black/20 y border-t para integración total */}
      <footer className="mt-8 py-10 w-full">
        <p className="text-center text-[10px] md:text-xs text-yellow-500/40 font-mono tracking-[0.5em] uppercase">
          {language === "es"
            ? "Estado del Ritual: Zap Sol Ascendido ⚡"
