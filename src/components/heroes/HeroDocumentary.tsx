...
export default function HeroDocumentary() {
  ...
  return (
    <section className="relative w-full h-screen bg-[#0F0B1E] overflow-hidden flex flex-col items-center">
      ...
      <div className="relative z-10 w-full max-w-[1400px] h-full mx-auto flex flex-col justify-between py-6 md:py-8">
        {/* 1. Cabecera - Igual que antes pero más limpia */}
        <div className="w-full flex flex-col md:flex-row items-end justify-between gap-4 shrink-0 px-6">
          ...
          <p className="hidden md:block text-indigo-200/40 font-mono text-sm max-w-sm text-right leading-tight border-r border-white/10 pr-6">
            {language === "es"
        ...
        {/* 2. El Marco del Vídeo - USANDO LAS MEDIDAS DE HEROSECTION / GALLERY */}
        <div className="w-full px-4 md:px-6">
          <div className="relative aspect-video w-full rounded-2xl md:rounded-3xl overflow-hidden border border-white/10 shadow-[0_0_80px_rgba(0,0,0,0.9)] bg-black">
            {/* El componente ahora llenará este aspect-video como en el HeroSection */}
        ...
        {/* 3. Mensaje inferior - Integrado en el fondo */}
        <div className="w-full flex flex-col justify-center items-center pb-4 shrink-0">
          ...
          <div className="w-32 h-[1px] bg-gradient-to-r from-transparent via-[#FFA908]/20 to-transparent mt-3"></div>
        </div>
      </div>
    </section>
  );
