...
export default function GuardianRoomMonkeSol() {
  ...
  return (
    <section className="relative min-h-[640px] px-6 py-16 bg-gradient-to-b from-slate-900 to-slate-800 rounded-xl shadow-lg overflow-hidden flex flex-col justify-center">
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center flex flex-col items-center space-y-6">
        <h3 className="text-4xl md:text-5xl font-bold text-red-400 animate-fadeInUp">
          {t("monkesol.title")}
        </h3>
        <p
          className="text-lg md:text-xl text-orange-300 animate-fadeInUp"
        ...
        <img
          ...
          alt="MonkeSol"
          className="w-64 h-64 object-contain drop-shadow-[0_0_25px_#f87171] animate-fadeInUp"
          style={{ animationDelay: "0.6s" }}
        />

        {/* Imagen MonkeSol con aura centrada */}
        <div className="relative flex justify-center items-center animate-in fade-in slide-in-from-left duration-1000">
