...
export default function GuardianRoomMonkeSol() {
  ...
  return (
    <section className="relative px-6 py-16 bg-gradient-to-b from-slate-900 to-slate-800 rounded-xl shadow-lg overflow-hidden">
      ...
      <div className="absolute top-0 left-2/6 w-1 h-full bg-gradient-to-b from-red-600 to-transparent animate-[pulse_2s_infinite]" />
      <div className="absolute top-0 left-4/6 w-1 h-full bg-gradient-to-b from-orange-400 to-transparent animate-[pulse_3s_infinite]" />
