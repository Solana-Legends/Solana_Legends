  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-[#0F0B1E] via-[#1A1530] to-[#0F0B1E] overflow-hidden">
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 text-center">
        ...
        {/* Badges */}
        <div className="flex flex-wrap justify-center gap-4 mb-2 -mt-4 animate-in fade-in slide-in-from-bottom duration-1000">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center animate-in fade-in slide-in-from-bottom duration-1000 -mt-8">
          <Button
            size="lg"
            variant="outline"
