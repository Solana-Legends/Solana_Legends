...
export default function ProgressSection() {
  ...
  return (
    <>
      ...
      {/* 🔥 ZapSol fuera del section, pegado al borde derecho */}
      <div className="fixed bottom-0 right-0 z-10 w-80 h-80 flex justify-center items-center animate-in fade-in slide-in-from-right duration-1000">
