      ...
      <div className="relative z-10 max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-12">
          ...
          <Card className="bg-[#1A1530]/40 border border-[#FFA908]/30 rounded-xl hover:shadow-[0_0_25px_#FFA908] transition-all duration-300">
            <CardHeader>
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  <CardTitle className="text-white text-xl">{t('project.whitepaper')}</CardTitle>
                  <CardDescription className="text-purple-300">{t('project.whitepaperDesc')}</CardDescription>
                </div>
              </div>
            </CardHeader>
            <CardContent>
          ...
          <Card className="bg-[#1A1530]/40 border border-[#FFA908]/30 rounded-xl">
            <CardHeader>
              <CardTitle className="text-white text-xl mb-4">{t('project.features')}</CardTitle>
            </CardHeader>
